...
public interface AmzInventoryOverviewMapper extends BaseMapper<AmzInventoryOverviewEntity> {
    ...
    @Insert("INSERT INTO amz_inventory_overview (sid, seller_sku, warehouse_sku, asin, principal_name, store, last_star, review_num, ad_rate, profit_rate30d, refund_rate90d, " +
            "  fba_stock, fba_inbound, total_inventory, sales7d, sales14d, sales30d, sales60d, sales_speed14d, sales_speed30d, sales_speed60d) " +
